...
export default function CreateCurriculumScreen() {
  ...
  const handleCreate = async () => {
    try {
      ...
      console.log('➕ Criando currículo...');
      console.log('Statement ID:', selectedStatementId);
      ...
      console.log('✅ Currículo criado:', newCurriculum.id);

      // Redireciona para os detalhes do novo currículo
      ...
      setError(
        ...
        'Erro ao criar currículo. Tente novamente.'
      );
    }
  };
          ...
          {!loadingStatements && statements && statements.length > 0 && (
            <>
              ...
              <VStack space="sm">
                ...
                >
                  <SelectTrigger>
                    <SelectInput placeholder="Escolha um statement" />
                    <SelectIcon mr="$3">
                  ...
                  <Card p="$4" bg="$white" borderRadius="$lg" mt="$2">
                    <VStack space="sm">
                      ...
                      <Text color="$primary" fontSize="$sm" fontWeight="$medium">
                        {statements.find(s => s.id === selectedStatementId)?.title}
                      </Text>
                      <Text color="$textLight" fontSize="$xs" numberOfLines={3}>
                        {statements.find(s => s.id === selectedStatementId)?.text}
                      </Text>
                    </VStack>
                  </Card>
                )}
